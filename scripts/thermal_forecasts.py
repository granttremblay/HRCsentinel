...
for i, msidname in zip(color_idx, names):
    ...
    ax.plot_date(data["{}_times".format(msidname)][364:], all_trends["{}_trend".format(msidname)], '-', label='{}'.format(msidname), lw=3.0, color=plt.cm.RdBu_r(i), rasterized=rasterized)
